            ...
            <nav class="navbar navbar-dark align-items-start sidebar sidebar-dark accordion bg-gradient-primary p-0">
                <div class="container-fluid d-flex flex-column p-0">
                    ...
                    <ul class="navbar-nav text-light" id="accordionSidebar">
                        <li class="nav-item">
                            <a class="nav-link" href="index.html"><i class="fas fa-tachometer-alt"></i><span>Ballina</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link active" href="evente.html"><i class="fas fa-user"></i><span>Evente</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="sallat.html"><i class="fas fa-table"></i><span>Sallat</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="kontakto.html"><i class="far fa-user-circle"></i><span>Kontakti</span></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" href="about%20EDIT!!!.html"><i class="fas fa-user-circle"></i><span>Rreth kinemase tone</span></a>
                        </li>
                    </ul>
                        ...
                        <div class="container-fluid">
                            ...
                            <form class="d-none d-sm-inline-block me-auto ms-md-3 my-2 my-md-0 mw-100 navbar-search">
                                <div class="input-group">
                                    <input class="bg-light form-control border-0 small" type="text" placeholder="Search for ..." /><button class="btn btn-primary py-0" type="button"><i class="fas fa-search"></i></button>
                                </div>
                            </form>
                                ...
                                <li class="nav-item dropdown no-arrow">
                                    <div class="nav-item dropdown no-arrow">
                                        <a class="dropdown-toggle nav-link" aria-expanded="false" data-bs-toggle="dropdown" href="#">
                                            <span class="d-none d-lg-inline me-2 text-gray-600 small">Valerie Luna</span><img class="border rounded-circle img-profile" src="assets/img/avatars/avatar1.jpeg" />
                                        </a>
                                    ...
                                    <div class="container">
                                        ...
                                        <div class="row justify-content-center">
                                            ...
                                            <div class="col-md-8 text-center">
                                                ...
                                                <h6 class="subtitle font-weight-normal">Events happening in the upcoming days!</h6>
                                            </div>
                                            <!-- Column -->
                                            <!-- Column -->
                                        </div>
