          ...
          <div class="container">
            <div class="row">
              ...
              <div class="col-md-4">
                ...
                <p>
                  Ngjarja e filmit<br /><?php echo $result['Plot'] ?>
                </p>
                ...
                <ul class="list-unstyled">
                  ...
                  <li class="text-break"><?php echo $result['Aktoret'] ?></li>
                  <li class="text-break"><?php echo $result['Regjisor'] ?></li>
                  <li class="text-break"><?php echo $result['BoxOffice'] ?></li>
                </ul>
              </div>
            </div>
